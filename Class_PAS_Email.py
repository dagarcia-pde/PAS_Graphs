...
class EmailUpdate:
    ...
    def lookAhead(self, plot_data):
        ...
        missing_data_rows = missing_data_rows[missing_data_rows['FAB_RECEIVED']==0] 

        keepcol = ['LAYER','Estimated Ship Date', 'Fab Required Date']
        missing_data_rows = missing_data_rows[keepcol]
